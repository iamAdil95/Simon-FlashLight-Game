...
// This gets the saved high score from the browser, or uses 0 if none is saved yet.
let btns = ["yellow", "red", "purple", "green"];

let started = false; // abhi game shuru nahi hua hai
let level = 0; // game ka level

let h2 = document.querySelector("h2");
let highScoreDisplay = document.getElementById("high-score");
// This finds the <h3> element so we can update its text.
...
//max highest score homework and print it